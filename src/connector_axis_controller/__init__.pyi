...
def get_counterbore_diameter_for_start_side(axis_id: int, section_index: int) -> float:
    """
...
def set_counterbore_for_start_side(axis_id: int, section_index: int, diameter: float, depth: float, is_conical: bool) -> None:
    """
...
def set_counterbore_for_end_side(axis_id: int, section_index: int, diameter: float, depth: float, is_conical: bool) -> None:
    """
...
def get_intersection_count(axis_id: int) -> int:
    """
...
def set_section_oblong_drilling_is_enabled(axis_id: int, section_index: int, positive_value: float, negative_value: float, angle: float) -> None:
    """
